      ...
      <div class="body" style="max-width: none;">
        ...
        <main class="table">
          <section class="table_header">
            <h1 style="margin:0; padding:0;">Select Item of Transaction from <?= htmlspecialchars($shop["shop"]) ?> Shop</h1>
          ...
          <section class="table_body">
            <table>
              <thead><tr>
               ...
               <th style="text-align:center;"><h3 style="margin:0; padding:0;"><b>
                 Minimum Amount <span class="icon_arrow">&UpArrow;</span></b></h3></th>
               <th style="text-align:center;"><h3 style="margin:0; padding:0;"><b>
                 Maximum Amount <span class="icon_arrow">&UpArrow;</span></b></h3></th>
               <th style="text-align:center;"><h3 style="margin:0; padding:0;"><b>
                 Current Amount <span class="icon_arrow">&UpArrow;</span></b></h3></th>
             </tr></thead>
             ...
             <tbody>
              ...
              ?>
              <tr data-href="transaction.php?i_id=<?php echo($data['ID']) ?>">
                <td><?php echo $sn; ?></td>
                ...
                <td style="<?php if ($data['amount'] < $data['Min_amount']) echo 'background-color: red;';
                                 elseif ($data['amount'] > $data['Max_amount']) echo 'background-color: blue;';
                                 else echo 'background-color: green;';?> opacity: 50%;">
